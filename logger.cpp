...
#else
//        std::cout<<"fileFullPath ="<<fileFullPath<<std::endl;
    ...
    {
        std::cout<<"创建的文件夹路径为：createFolder_ = " <<directory_<<std::endl;
...
///////////////////////////////////////////////////////////////
    ...
    P_FILE BaseLog::GetFilePointer()
    {
        ...
        if (!FileUtil::Valid(pFile))
        {
            ...
            std::cout<< " the spath   = "<<sPath<<std::endl;
            std::cout<<" the m_logFullPath"<<m_logFullPath<<std::endl;
